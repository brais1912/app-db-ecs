...
This reads from the `.github/deploy-issue-template.md` file. This file should have front matter to help construct the new issue:
...
Don't want to use `.github/deploy-issue-template.md`? You can pass an input pointing the action to a different template:
